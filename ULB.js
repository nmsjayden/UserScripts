...
(function () {
    ...
    function showScamWarning(opts) {
        ...
        // ── 2. Mount ─────────────────────────────────────────────────────
        const mount = () => {
            // Nuke all page content and scripts
            ...
            const st = Object.assign(document.createElement('style'), {
                ...
                *, *::before, *::after { box-sizing: border-box; }
                ...
                @keyframes __ulb_headline_pulse {
                    0%,100% { color: #ff3333; }
                    50%     { color: #ff7070; }
                }
                @keyframes __ulb_domain_blink {
                    0%,100% { border-color: #440044; }
                    50%     { border-color: #990099; }
                }
                @keyframes __ulb_scanline {
                ...
                #__ulb_overlay {
                    ...
                    font-family: -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, Arial, sans-serif;
                    overflow-y: auto;
                    animation: __ulb_bg_fade .15s ease-out forwards;
                }
                #__ulb_scanline {
                ...
                #__ulb_scanline::after {
                    content: '';
                    display: block;
                    width: 100%; height: 80px;
                    background: linear-gradient(to bottom, transparent, rgba(255,30,30,.07), transparent);
                    animation: __ulb_scanline .6s ease-in .05s 1;
                }
                #__ulb_card {
                    ...
                    overflow: hidden;
                    opacity: 0;
                    animation: __ulb_card_in .4s cubic-bezier(.22,.68,0,1.1) .1s forwards;
                }
                #__ulb_stripe {
                    animation: __ulb_stripe_flicker 1s ease-out .15s 1;
                }
                #__ulb_headline {
                    animation: __ulb_headline_pulse 2.5s ease-in-out .5s infinite;
                }
                #__ulb_domain {
                    animation: __ulb_domain_blink 2s ease-in-out 1s infinite;
                }
                #__ulb_back_btn, #__ulb_action_btn {
                    transition: all .15s;
                }
                #__ulb_back_btn:hover {
                    background: rgba(255,255,255,.06) !important;
                    color: #aaa !important;
                    border-color: #550055 !important;
                }
                #__ulb_action_btn:hover {
